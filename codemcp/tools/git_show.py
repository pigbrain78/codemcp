...
async def git_show(
    ...
    Example:
      GitShow  # Show the most recent commit
      GitShow arguments="a1b2c3d"  # Show a specific commit by hash
      GitShow arguments="HEAD~3"  # Show the commit 3 before HEAD
      GitShow arguments="HEAD:path/to/file"  # Show a file from a specific commit
    ...
    try:
        ...
        logging.error(f"Error in git_show: {e}", exc_info=True)
