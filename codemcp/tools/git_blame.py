...
async def git_blame(
    ...
    Example:
      GitBlame arguments="path/to/file"  # Show blame information for a file
      GitBlame arguments="-L 10,20 path/to/file"  # Show blame information for lines 10-20
      GitBlame arguments="-w path/to/file"  # Ignore whitespace changes
    ...
    try:
        ...
        output = await git_blame_command(
        ...
        logging.error(f"Error in git_blame: {e}", exc_info=True)
        return f"Error executing git blame: {e}"
